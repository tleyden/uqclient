...
func init() {
  ...
  RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.uqclient.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".uqclient") // name of config file (without extension)
